...
if(!class_exists('Idyllic_Plus_Features')){
	class Idyllic_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_attr_e( 'Review Us', 'idyllic' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/idyllic/' ); ?>" target="_blank" id="about_idyllic">
			<?php esc_html_e( 'Review Us', 'idyllic' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/idyllic/' ); ?>" title="<?php esc_attr_e( 'Theme Instructions', 'idyllic' ); ?>" target="_blank" id="about_idyllic">
			<?php esc_html_e( 'Theme Instructions', 'idyllic' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com/' ); ?>" title="<?php esc_attr_e( 'Support Tickets', 'idyllic' ); ?>" target="_blank" id="about_idyllic">
			<?php esc_html_e( 'Forum', 'idyllic' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://www.facebook.com/themefreesia/' ); ?>" title="<?php esc_attr_e( 'Facebook', 'idyllic' ); ?>" target="_blank" id="about_idyllic">
			<?php esc_html_e( 'Facebook', 'idyllic' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://twitter.com/themefreesia' ); ?>" title="<?php esc_attr_e( 'Twitter', 'idyllic' ); ?>" target="_blank" id="about_idyllic">
