		...
		<div class="fact-figure-box">
			<div class="fact-figure-bg"<?php if(!empty($idyllic_fact_fig_box_bg_image)): ?> style="background-image:url('<?php echo esc_url($idyllic_fact_fig_box_bg_image); endif; ?>');">
				<div class="wrap">
					...
					if($idyllic_settings['idyllic_fact_figure_box_title'] !='' || $idyllic_settings['idyllic_fact_figure_box_description'] !='') { ?>
						<div class="box-header">
							...
							if($idyllic_settings['idyllic_fact_figure_box_description'] !=''){ ?>
								<p class="box-sub-title freesia-animation zoomIn" data-wow-delay="0.3s"><?php echo esc_html($idyllic_settings['idyllic_fact_figure_box_description']); ?></p>
							<?php } ?>
						</div><!-- end .box-header -->
					<?php } ?>
					...
					<?php else: ?>
						<a class="btn-default dark" href="<?php echo esc_url($idyllic_settings['idyllic_img_fact_fig_boxlink']);?>" title="<?php echo esc_attr($idyllic_settings[ 'idyllic_tag_text' ]);?>"><?php echo esc_html($idyllic_settings[ 'idyllic_tag_text' ]);?></a>
					<?php endif; ?>
				</div><!-- end .wrap -->
