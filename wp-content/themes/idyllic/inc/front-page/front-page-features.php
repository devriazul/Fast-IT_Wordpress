				...
				<div class="wrap">
					...
					if($idyllic_settings['idyllic_features_title'] != '' || $idyllic_settings['idyllic_features_description'] != ''){
						...
						if($idyllic_settings['idyllic_features_title'] != ''){ ?>
							<h2 class="box-title freesia-animation zoomIn" data-wow-delay="0.3s"><?php echo esc_html($idyllic_settings['idyllic_features_title']);?> </h2>
						<?php }
						if($idyllic_settings['idyllic_features_description'] != ''){ ?>
							<p class="box-sub-title freesia-animation zoomIn" data-wow-delay="0.3s"><?php echo esc_html($idyllic_settings['idyllic_features_description']); ?></p>
						<?php }
