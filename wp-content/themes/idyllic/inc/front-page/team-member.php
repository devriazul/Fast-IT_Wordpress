						...
						<div class="team-wrap">
							<div class="box-header">
								<?php	 if($idyllic_settings['idyllic_team_member_title'] != ''){ ?>
									<h2 class="box-title freesia-animation zoomIn" data-wow-delay="0.3s"><?php echo esc_html($idyllic_settings['idyllic_team_member_title']);?> </h2>
								<?php } ?>
								<?php
								if($idyllic_settings['idyllic_team_member_description'] != ''){ ?>
								<p class="box-sub-title freesia-animation zoomIn" data-wow-delay="0.3s"><?php echo esc_html($idyllic_settings['idyllic_team_member_description']);?></p>
								<?php } ?>
							</div><!-- end .box-header -->
												...
												<div class="team-info">
													...
													<?php if($idyllic_settings['idyllic_our_team_remove_link']==0){ ?>
														...
														<?php } else { ?>
															<?php the_title();?></h3>
														<?php	}
														the_content(esc_html($idyllic_settings['idyllic_tag_text'])); ?>
													</div>
												</div> <!-- end .team-info -->
											<?php endif; ?>
