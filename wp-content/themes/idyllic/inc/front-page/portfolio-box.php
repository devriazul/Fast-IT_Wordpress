			...
			<div class="wrap">
				<div class="box-header">
					<?php	 if($idyllic_settings['idyllic_portfolio_title'] != ''){ ?>
						<h2 class="box-title freesia-animation zoomIn" data-wow-delay="0.4s"><a title="<?php echo esc_attr($idyllic_settings['idyllic_portfolio_title']);?>" href="<?php echo esc_url(get_category_link($idyllic_settings['idyllic_portfolio_category_list'])); ?>"><?php echo esc_html($idyllic_settings['idyllic_portfolio_title']);?> </a></h2>
					<?php } ?>
					...
					<p><?php echo esc_html($idyllic_settings['idyllic_portfolio_description']);?></p>
					<?php } ?>
				</div><!-- end .box-header -->
			</div><!-- end .wrap -->
